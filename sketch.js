...
if(lstones.body.position.x- lmango.body.position.x<lmango.diametre + lstones.diametre
   ...
   &&lstones.body.position.y-lmango.position.y<lmango.diametre+lstones.diametre
   && lmango.body.position.y - lstones.position.y<lmango.diametre + lstones.diametre){
